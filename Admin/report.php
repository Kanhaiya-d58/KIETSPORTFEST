        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="report.php">Game Wise</a></li>
        ...
        <!-- sidebar menu end-->
			...
			<div class="container" style="margin-left:400px; margin-top:100px;">
				...
				<br><br><br>
					...
					<label for="game">Game Wise:</label>
						<select class="txt2" name="game" required="">
						<option >Select</option>
					<option value="cricket">Cricket</option>
					<option value="football">Football</option>
					<option value="vollyball">Vollyball</option>
					<option value="teable tennis">Table Tennis</option>
					...
					$query="select * from registration where game='$game'";
