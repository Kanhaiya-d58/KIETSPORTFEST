			...
			<div class="item item2">
				<div class="container">
					<div class="carousel-caption">
						<h6><span><font size="20px" color="yellow">..</font></span></h6>
						<h3><span>.. </span>
						</h3>
		...
		<div class="container">
			...
			<div class="welcome-sub-wthree">
				<div class="col-md-6 banner_bottom_left">
					...
					<p>n 1958, William Higinbotham created a game called Tennis for Two, a competitive two-player tennis game played on an oscilloscope. The players would select the angle at which to put their racket, and pressed a button to return it.
					Although this game was incredibly simple, it demonstrated how an action game (rather than previous puzzles) could be played on a computer.[2</p>
					<p>A physical activity, Sport is carried out under an agreed set of rules. Sport is related to recreational purpose, either for self-enjoyment or competition or for both.
					A game is also for recreational activities and it involves one or more players. ... As like sport, game is also played for enjoyment.</p>
				</div>
				<!-- Stats-->
			...
			<div class="services-moksrow">
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Certification</h4>
						<p>All student participate in any game college provide the certificate..</p>
				...
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Refreshment</h4>
						<p>Provide the Refreshment All participate student in any game....</p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<p>All participate student any physical problem provide the Mediacal Facilities.... </p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="services-moksrow">
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						...
						<h4>Hostel</h4>
						<p>Other college Students participate in any game provide the Hostel...</p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						<span class="fa fa-bullhorn icon" aria-hidden="true"></span>
						<h4>Game Accesariees</h4>
						<p>Game Accesariees provide the college..</p>
					</div>
				</div>
				<div class="col-xs-4 services-grids-w3l">
					<div class="servi-shadow">
						<span class="fa fa-laptop icon" aria-hidden="true"></span>
						<h4>Some Other Facilities</h4>
						<p>Some other Facilities provide the college to all participate students...</p>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color1">
								<a href="#" data-toggle="modal" data-target="#myModal">Cricket Game</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
								...
								<div class="time">
									<p>
										<span class="fa fa-map-marker" aria-hidden="true"></span> KIET, Ghazibad</p>
								</div>
								
								<div class="clearfix"> </div>
							</div>
							<div class="news-grid-info-bottom-w3ls-text">
								<p>Have Fun Enjoy The Game</p>
							</div>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color2">
								<a href="#" data-toggle="modal" data-target="#myModal">Football Game</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color3">
								<a href="#" data-toggle="modal" data-target="#myModal">Vollyball</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
					...
					<div class="col-md-6 yaallahaa-news-left">
						...
						<div class="col-xs-6 news-grid-info-bottom-w3ls">
							<div class="news-left-top-text text-color4">
								<a href="#" data-toggle="modal" data-target="#myModal">Basketball</a>
							</div>
							<div class="date-grid">
								<div class="admin">
									<a href="#">
			...
			<li>
					<div class="three_testimonials_grid_main">
						...
						<div class="col-xs-9 three_testimonials_grid">
							...
							<p>
								It's very good sports web application and very fast performance and good result....
							</p>
						</div>
						<div class="clearfix"> </div>
					</div>
				...
				<li>
					<div class="three_testimonials_grid_main">
						<div class="col-xs-3 three_testimonials_grid_pos">
							<div class="grid-test-allah-agile">
								<img src="images/cv2.jpg" alt=" " class="img-responsive" />
							</div>
						</div>
						<div class="col-xs-9 three_testimonials_grid">
							<div class="three_testimonials_grid1">
				...
				<li>
					<div class="three_testimonials_grid_main">
						<div class="col-xs-3 three_testimonials_grid_pos">
							<div class="grid-test-allah-agile">
								<img src="images/sv3.jpg" alt="image not found" class="img-responsive"  />
							</div>
						</div>
						<div class="col-xs-9 three_testimonials_grid">
							<div class="three_testimonials_grid1">
				...
				<li>
					<div class="three_testimonials_grid_main">
						<div class="col-xs-3 three_testimonials_grid_pos">
							<div class="grid-test-allah-agile">
								<img src="images/sv4.jpg" alt=" " class="img-responsive" />
							</div>
						</div>
						<div class="col-xs-9 three_testimonials_grid">
							<div class="three_testimonials_grid1">
