		...
		<div class="row">
			...
			<div class="row">
				<form action="registration_code.php" method="post">
					...
					<div class="">
						<p>Mobile Number</p>
						<input type="number" class="number" name="mobile" Placeholder="Your Mobile Number"  required="" />
					</div>
					<div class="">
						<p>Password</p>
					...
					<div class="align_righ">
					
						<p style="align:right;">Year</p>
						<select class="txt2"name="year">
						<option >Select</option>
					...
					<option value="Lawn Tennis">Athletics</option>
					</select>
					</div>
					<div class="">
						<p>Gender</p>
					...
					<tr>
						<th>Date of Birth:</th>
							<td>
<select class="txt2"name="dob_year">
<option >Year</option>
...
<select class="txt4"name="dob_months">
<option >Month</option>
...
<select class="txt3"name="dob_date">
<option >Date</option>
